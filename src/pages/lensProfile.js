  ...
  return (
    <div class="h-screen bg-gray-200  dark:bg-gray-800   flex flex-wrap items-center  justify-center  ">
            <div class="container lg:w-2/6 xl:w-2/7 sm:w-full md:w-2/3    bg-white  shadow-lg    transform   duration-200 easy-in-out">
                ...
                {profile.picture ? (
                    <img class="h-32 w-32 bg-white p-2 rounded-full   " src={profile.picture.original.url} alt="" />
                ): (<img class="h-32 w-32 bg-white p-2 rounded-full   " src="https://www.kindpng.com/picc/m/451-4517876_default-profile-hd-png-download.png" alt="" />
                )}
                </div>
                <div class=" ">
